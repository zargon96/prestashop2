...
class Ps_mbo461AdminContainer extends Container
{
    ...
    {
        return $this->services['mbo.doctrine.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('', 0, 'C:\\laragon\\www\\prestashop/var/cache/prod\\%/ps_mbo');
    }
    ...
    {
        return $this->services['mbo.doctrine.cache.provider'] = new \Symfony\Component\Cache\DoctrineProvider(($this->services['mbo.doctrine.cache.adapter'] ?? ($this->services['mbo.doctrine.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('', 0, 'C:\\laragon\\www\\prestashop/var/cache/prod\\%/ps_mbo'))));
    }
